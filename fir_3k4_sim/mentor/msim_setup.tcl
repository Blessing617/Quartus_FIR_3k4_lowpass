...
# ----------------------------------------
# If fir_3k4 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 win32 2023.07.06.17:07:35
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm10_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm11_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm12_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm13_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm14_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm6_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm7_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm8_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm9_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_wi0_r0_ra20_count1_lut_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/fir_3k4_rtl_core.vhd"                           
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/fir_3k4_ast.vhd"                                
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/fir_3k4.vhd"                                    
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/fir_3k4_tb.vhd"                                 
}
