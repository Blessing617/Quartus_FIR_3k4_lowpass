...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm10_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm11_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm12_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm13_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm14_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm6_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm7_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm8_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_cm9_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_3k4_rtl_core_u0_m0_wo0_wi0_r0_ra20_count1_lut_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_3k4_rtl_core.vhd"                           
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_3k4_ast.vhd"                                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_3k4.vhd"                                    
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_3k4_tb.vhd"                                 
fi
